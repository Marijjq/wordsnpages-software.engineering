            ...
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    ...
                    <a class="action" href="mailto:example@gmail.com"><i class="far fa-envelope"></i>
                        wordsnpages@gmail.com</a>
                    <p><i class="fal fa-map-marker-alt"></i> Tetovo, Macedonia</p>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__copyright d-flex justify-content-center">
                        <p>Copyright © 2024 wordsnpages. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
    </div>
</footer><?php /**PATH C:\Users\stojk\laravel\wordsnpages\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>